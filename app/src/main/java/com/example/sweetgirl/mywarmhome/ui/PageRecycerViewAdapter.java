...
public class PageRecycerViewAdapter extends RecyclerView.Adapter<PageRecycerViewAdapter.ViewHolder>{
    ...
    public PageRecycerViewAdapter(Context context,ArrayList<String> datas){
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType){
        View itemView=layoutInflater.inflate(R.layout.item_first_page, parent,false);
    ...
    class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(View itemView){
            super(itemView);
            mText = (TextView)itemView.findViewById(R.id.tv_item);
            mImage = (ImageView)itemView.findViewById(R.id.iv_item);
            mDep=(TextView)itemView.findViewById(R.id.tv_item_time);
            mBtn=(Button)itemView.findViewById(R.id.btn_item);
