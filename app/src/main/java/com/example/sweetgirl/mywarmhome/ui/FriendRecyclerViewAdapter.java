...
public class FriendRecyclerViewAdapter extends RecyclerView.Adapter<FriendRecyclerViewAdapter.ViewHolder>{
    ...
    public FriendRecyclerViewAdapter(Context context,ArrayList<String> datas){
    ...
    class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(View itemView){
            super(itemView);
            mText = (TextView)itemView.findViewById(R.id.tv_item_name);
            mImage = (ImageView)itemView.findViewById(R.id.iv_item);
            mDep=(TextView)itemView.findViewById(R.id.tv_item_dep);
            mBtn=(TextView)itemView.findViewById(R.id.tv_item_time);
