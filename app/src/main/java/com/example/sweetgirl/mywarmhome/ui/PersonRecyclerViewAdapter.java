...
public class PersonRecyclerViewAdapter extends RecyclerView.Adapter<PersonRecyclerViewAdapter.ViewHolder> {
    ...
    public PersonRecyclerViewAdapter(Context context,ArrayList<String> datas){
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType){
        View itemView=layoutInflater.inflate(R.layout.item_me, parent,false);
    ...
    class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(View itemView){
            ...
            mDep=(TextView)itemView.findViewById(R.id.tv_item_me_time);
